...
class Test extends Component {
    ...
    data.append("file", imagedata);
        ...
        var req=request
              .post('https://railfeed.herokuapp.com/upload')
              .send(data);
  ...
  return (
    <div className="container mt-5">
            ...
            <div className="row">
              ...
              {this.state.file ? (<a href="https://railfeed.herokuapp.com/getFile.csv" type="button" className="btn btn-success" target="_blank" value="Download">Download</a>) : (<p></p>)}
